...
(() => {
  ...
  // webview-src/hooks/useNodeData.ts
  var import_react2 = __toESM(require_react());

  // webview-src/hooks/useVsCodeMessage.ts
  var import_react = __toESM(require_react());
  function useVsCodeMessage(handler) {
  ...
  function updateColumns(columns, node) {
    if (node.path === "$")
      return [node];
    ...
    const parentIndex = parentPath ? columns.findIndex((column) => column.path === parentPath) : -1;
    if (parentIndex >= 0) {
  ...
  // webview-src/components/ColumnBrowser.tsx
  var import_react4 = __toESM(require_react());

  // webview-src/components/ImagePreview.tsx
  ...
  function ImagePreview({ url }) {
    ...
    if (isHttp) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.warning, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: styles.icon, children: "\u26A0" }),
        "HTTP image blocked by security policy.",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "#", onClick: (e) => {
          e.preventDefault();
          postMsg(url);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: styles.container, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "img",
      {
        src: url,
        alt: "",
  ...
  // webview-src/components/StringRenderer.tsx
  var import_jsx_runtime2 = __toESM(require_jsx_runtime());
  function StringRenderer({ value, semantics, path }) {
    if (semantics?.kind === "image") {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ValueBox, { value, path }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ImagePreview, { url: semantics.url })
      ] });
    }
    if (semantics?.kind === "url") {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s.block, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.kind, children: "URL" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "a",
          {
            ...
            onClick: (e) => {
              e.preventDefault();
              postMessage({ type: "open.url", payload: { url: semantics.value } });
            },
            children: semantics.value
          }
        )
      ] });
    }
    if (semantics?.kind === "date") {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s.block, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.kind, children: "Date" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.dateMain, children: semantics.display }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.dateSub, children: relativeTime(new Date(semantics.iso)) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...s.mono, marginTop: 6, color: "var(--vscode-descriptionForeground)" }, children: semantics.iso })
      ] });
    }
    if (semantics?.kind === "color") {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s.block, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.kind, children: "Color" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s.colorRow, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...s.swatch, background: semantics.hex }, title: semantics.hex }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: s.mono, children: semantics.hex })
        ] })
      ] });
    }
    if (semantics?.kind === "email") {
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s.block, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.kind, children: "Email" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { href: `mailto:${semantics.value}`, style: s.link, children: semantics.value })
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ValueBox, { value, path });
  }
  function ValueBox({ value, path }) {
    const truncated = value.endsWith("\u2026(truncated)");
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { style: s.pre, children: value }),
      truncated && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.truncNote, children: "Value truncated for display" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s.actions, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          className: "secondary",
  ...
  function relativeTime(date) {
    ...
    if (abs < 6e4)
      ...
      str = `${prefix}${yr} year${yr > 1 ? "s" : ""}${suffix}`;
    else if (mo > 0)
      str = `${prefix}${mo} month${mo > 1 ? "s" : ""}${suffix}`;
    else if (day > 0)
      str = `${prefix}${day} day${day > 1 ? "s" : ""}${suffix}`;
    else if (hr > 0)
      str = `${prefix}${hr} hour${hr > 1 ? "s" : ""}${suffix}`;
    else
      str = `${prefix}${min} minute${min > 1 ? "s" : ""}${suffix}`;
    return str;
  }
  var s = {
    block: { marginTop: 4 },
  ...
  // webview-src/components/NumberRenderer.tsx
  var import_jsx_runtime3 = __toESM(require_jsx_runtime());
  var SEC_MIN = 1e9;
  var SEC_MAX = 2e10;
  var MS_MIN = 1e12;
  var MS_MAX = 2e13;
  function detectTimestamp(n) {
    if (!Number.isInteger(n))
      return null;
    if (n > SEC_MIN && n < SEC_MAX)
      return new Date(n * 1e3);
    if (n > MS_MIN && n < MS_MAX)
      return new Date(n);
    return null;
  }
  function NumberRenderer({ value, path }) {
    const timestamp = detectTimestamp(value);
    const formatted = value.toLocaleString(void 0, { maximumFractionDigits: 20 });
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: s2.value, children: formatted }),
      timestamp && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: s2.hint, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: s2.label, children: "Unix timestamp \u2192" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: s2.ts, children: timestamp.toLocaleString() })
      ] }),
      !Number.isInteger(value) && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: s2.hint, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: s2.label, children: "Exact \u2192" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: s2.mono, children: value })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: s2.actions, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: "secondary", onClick: () => postMessage({ type: "copy.value", payload: { path } }), children: "Copy" }) })
    ] });
  }
  var s2 = {
    value: {
  ...
  function ColumnBrowser({ columns, selectedNode, searchResult }) {
    const [searchText, setSearchText] = (0, import_react4.useState)("");
    const [activeSearch, setActiveSearch] = (0, import_react4.useState)({ query: "", results: [] });
    const [autoOpenedQuery, setAutoOpenedQuery] = (0, import_react4.useState)("");
    ...
    const matchedPaths = (0, import_react4.useMemo)(() => results.map((result) => result.path), [results]);
    const visibleColumns = selectedNode.childPreviews.length === 0 && trail[trail.length - 1]?.path === selectedNode.path ? trail.slice(0, -1) : trail;
    const displayedColumns = searchActive ? visibleColumns.filter((column) => column.path === "$" || matchedPaths.some((path) => isPathPrefix(column.path, path))) : visibleColumns;
    const showDetail = !searchActive || matchedPaths.some(
      (path) => path === selectedNode.path || isPathPrefix(selectedNode.path, path)
    );
    ...
    (0, import_react4.useEffect)(() => {
      if (!searchResult || searchResult.query !== searchText)
        return;
      setActiveSearch(searchResult);
    }, [searchResult, searchText]);
    (0, import_react4.useEffect)(() => {
      if (!searchActive || activeSearch.query !== searchText || !activeSearch.results[0])
        return;
      if (autoOpenedQuery === searchText)
        return;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.root, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.breadcrumb, "aria-label": "path", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.searchWrap, children: [
          ...
          searchActive && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.searchCount, children: activeSearch.query === searchText ? `${results.length}` : "..." })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: s3.breadcrumbPath, children: selectedNode.breadcrumb.map((seg, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_react4.default.Fragment, { children: [
          i > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.sep, children: "\u203A" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "span",
            {
              style: i === selectedNode.breadcrumb.length - 1 ? s3.crumbActive : s3.crumb,
              onClick: () => i < selectedNode.breadcrumb.length - 1 && postMessage({ type: "navigate.path", payload: { path: seg.path } }),
              children: seg.label
            }
          )
        ] }, seg.path)) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.browser, children: [
        displayedColumns.map((column) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            ...
            {
              node: column,
              selectedChildPath: trailIndex >= 0 ? trail[trailIndex + 1]?.path : void 0,
              matchedPaths,
              searchActive
            },
            column.path
        ...
        showDetail && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DetailColumn, { node: selectedNode })
      ] })
    ] });
  }
  function Column({ node, selectedChildPath, matchedPaths, searchActive }) {
    const childRows = searchActive ? node.childPreviews.filter((child, index) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { style: s3.column, "aria-label": title, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.columnHeader, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.columnTitle, title, children: title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.columnCount, children: formatCount(node) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.columnBody, children: [
        childRows.map((child) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "button",
            {
              style: { ...s3.row, ...selected ? s3.rowSelected : void 0 },
              title: `${child.key} \xB7 ${child.type}`,
              onClick: () => postMessage({ type: "navigate.path", payload: { path: childPath } }),
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: s3.rowMain, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.key, title: child.key, children: formatChildKey(node.type, child.key, index) }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { ...s3.preview, color: TYPE_COLOR[child.type] }, children: formatChildValue(child) })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: s3.rowMeta, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.type, children: child.type }),
                  (child.type === "object" || child.type === "array") && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.chevron, children: "\u203A" })
                ] })
              ]
            },
            `${child.key}-${index}`
        ...
        hidden > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.more, children: [
          "... ",
          hidden,
          " more"
        ] }),
        searchActive && childRows.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: s3.more, children: "No matches" })
      ] })
    ] });
  }
  function DetailColumn({ node }) {
    const name = node.path === "$" ? "(root)" : node.breadcrumb[node.breadcrumb.length - 1]?.label ?? node.path;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("aside", { style: s3.detail, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.detailHeader, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.detailName, title: name, children: name }),
      ...
      (node.type === "object" || node.type === "array") && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.actions, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            style: s3.actionBtn,
        ...
        node.type === "array" && node.childPreviews.some((child) => child.type === "object") && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "button",
          {
            style: s3.actionBtn,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: s3.detailBody, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(NodeDetail, { node }) })
    ] });
  }
  function NodeDetail({ node }) {
    switch (node.type) {
      case "string":
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StringRenderer, { value: String(node.value ?? ""), semantics: node.semantics, path: node.path });
      case "number":
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(NumberRenderer, { value: Number(node.value), path: node.path });
      case "boolean":
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScalarDetail, { value: String(node.value), path: node.path, tone: node.value ? "#4ec9b0" : "#f44747" });
      case "null":
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScalarDetail, { value: "null", path: node.path, tone: "var(--vscode-descriptionForeground)", italic: true });
      case "object":
      case "array":
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.summary, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: s3.summaryValue, children: formatCount(node) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: s3.summarySub, children: formatShownCount(node) })
        ] });
    }
  }
  function ScalarDetail({ value, path, tone, italic }) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { ...s3.scalar, color: tone, fontStyle: italic ? "italic" : "normal" }, children: value }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: s3.actions, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "secondary", onClick: () => postMessage({ type: "copy.value", payload: { path } }), children: "Copy" }) })
    ] });
  }
  function appendChildPath(parentPath, parentType, key, index) {
    if (parentType === "array") {
  ...
  function formatChildKey(parentType, key, index) {
  ...
  function FieldAnalysisView({ payload, onBack }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s4.root, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s4.header, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { onClick: onBack, style: s4.backBtn, children: "\u2190 Back" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: s4.title, children: "Field Analysis" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: s4.path, children: payload.arrayPath })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s4.meta, children: [
        payload.totalItems.toLocaleString(),
        " items",
        sampled && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: s4.sampled, children: [
          " \xB7 sampled ",
          payload.sampledItems.toLocaleString()
        ] }),
        payload.skippedNonObjects > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: s4.skipped, children: [
          " \xB7 ",
      ...
      payload.rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s4.empty, children: "No object items found in array." }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("table", { style: s4.table, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("tr", { children: [
          ["key", "count", "coverage", "status"].map((col) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("th", { style: { ...s4.th, ...s4.thClickable }, onClick: () => handleSort(col), children: [
            colLabel(col),
            sortKey === col ? sortDir === "asc" ? " \u2191" : " \u2193" : ""
          ] }, col)),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { style: s4.th, children: "Types" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tbody", { children: sorted.map((row) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "tr",
          {
            style: s4.tr,
            onClick: () => postMessage({ type: "navigate.path", payload: { path: row.firstPath } }),
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { style: { ...s4.td, ...s4.keyCell }, children: row.key }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { style: { ...s4.td, ...s4.numCell }, children: row.count.toLocaleString() }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { style: { ...s4.td, ...s4.numCell }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CoverageBar, { coverage: row.coverage }) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { style: { ...s4.td, ...s4.statusCell }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(StatusBadge, { status: row.status }) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { style: s4.td, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s4.types, children: row.types.map((t) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: s4.typeBadge, children: t }, t)) }) })
            ]
          },
          row.key
        )) })
  ...
  function CoverageBar({ coverage }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s4.barTrack, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { ...s4.barFill, width: `${pct}%` } }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: s4.pct, children: [
        pct,
        "%"
      ] })
    ] });
  ...
  function StatusBadge({ status }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { ...s4.statusDot, color }, children: statusLabel(status) });
  }
  function statusOrder(s6) {
    return s6 === "inconsistent" ? 0 : s6 === "sparse" ? 1 : 2;
  }
  function statusLabel(s6) {
    return s6 === "inconsistent" ? "inconsistent" : s6 === "sparse" ? "sparse" : "ok";
  }
  function colLabel(k) {
  ...
  function SchemaView({ payload, onBack }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s5.root, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s5.header, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { onClick: onBack, style: s5.backBtn, children: "\u2190 Back" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.title, children: "JSON Schema" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s5.meta, children: [
        nodeCount.toLocaleString(),
        " nodes \xB7 inferred ",
        new Date(inferredAt).toLocaleTimeString()
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SchemaNode, { schema, name: "(root)", required: true, depth: 0 })
    ] });
  }
  function SchemaNode({ schema, name, required, depth }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { marginLeft: depth > 0 ? 16 : 0 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "div",
        {
          style: { ...s5.row, cursor: hasChildren ? "pointer" : "default" },
          onClick: hasChildren ? () => setOpen((o) => !o) : void 0,
          children: [
            hasChildren && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.arrow, children: open ? "\u25BE" : "\u25B8" }),
            !hasChildren && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.arrowSpacer }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.keyName, children: name }),
            required && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.requiredDot, title: "required", children: "*" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...s5.typeBadge, background: typeColor(schema) }, children: typeLabel }),
            schema.format && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.formatBadge, children: schema.format }),
            schema.enum && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.enumHint, children: formatEnum(schema.enum) })
          ]
        }
      ),
      open && hasChildren && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s5.children, children: [
        schema.properties && Object.entries(schema.properties).map(([key, child]) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          SchemaNode,
          {
            schema: child,
            name: key,
        ...
        schema.items && !schema.properties && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          SchemaNode,
          {
            schema: schema.items,
            name: "[items]",
  ...
  function App() {
    const { selectedNode, columns, analysisResult, schemaResult, searchResult, loading, error } = useNodeData();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ColumnBrowser, { selectedNode, columns, searchResult });
  }
