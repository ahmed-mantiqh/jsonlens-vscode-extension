...
(() => {
  ...
  // webview-src/components/NodePreview.tsx
  ...
  // webview-src/components/ObjectSummary.tsx
  ...
  function ObjectSummary({ childCount, childPreviews, path }) {
    const shown = childPreviews.length;
    const hidden = childCount - shown;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.meta, children: [
        childCount,
        " ",
        childCount === 1 ? "key" : "keys"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.table, children: [
        childPreviews.map((c) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: s3.row, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { ...s3.val, color: TYPE_COLOR[c.type] ?? "inherit" }, children: formatChildValue(c) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s3.type, children: c.type })
        ] }, c.key)),
  ...
  // webview-src/components/ArraySummary.tsx
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  function ArraySummary({ childCount, childPreviews, path }) {
    const shown = childPreviews.length;
    const hidden = childCount - shown;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s4.list, children: [
        childPreviews.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s4.item, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: s4.val, children: formatItem(c) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: s4.type, children: c.type })
        ] }, i)),
        hidden > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s4.more, children: [
          "\u2026 ",
          hidden,
          " more ",
          hidden === 1 ? "item" : "items"
  ...
  function formatItem(c) {
    if (c.type === "object")
      return `{${c.childCount ?? "?"} keys}`;
    if (c.type === "array")
      return `[${c.childCount ?? "?"} items]`;
    if (c.type === "null")
      return "null";
    if (c.value === void 0)
      return "";
  ...
  function NodePreview({ node }) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s5.root, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("nav", { style: s5.breadcrumb, "aria-label": "path", children: node.breadcrumb.map((seg, i) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_react4.default.Fragment, { children: [
        i > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.sep, children: "\u203A" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "span",
          {
            style: i === node.breadcrumb.length - 1 ? s5.crumbActive : s5.crumb,
            onClick: () => i < node.breadcrumb.length - 1 && postMessage({ type: "navigate.path", payload: { path: seg.path } }),
            children: seg.label
          }
        )
      ] }, seg.path)) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s5.header, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s5.keyLabel, children: node.breadcrumb.length > 1 ? node.breadcrumb[node.breadcrumb.length - 1].label : "(root)" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "span",
          {
            style: {
  ...
  function NodeBody({ node }) {
    switch (node.type) {
      case "string":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StringRenderer, { value: String(node.value ?? ""), semantics: node.semantics, path: node.path });
      case "number":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(NumberRenderer, { value: Number(node.value), path: node.path });
      case "boolean":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BooleanRenderer, { value: Boolean(node.value), path: node.path });
      case "null":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(NullRenderer, { path: node.path });
      case "object":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ObjectSummary, { childCount: node.childCount, childPreviews: node.childPreviews, path: node.path });
      case "array":
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ArraySummary, { childCount: node.childCount, childPreviews: node.childPreviews, path: node.path });
      default:
        return null;
    }
  }
  function BooleanRenderer({ value, path }) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { ...s5.boolVal, color: value ? "#4ec9b0" : "#f44747" }, children: String(value) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s5.actions, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { className: "secondary", onClick: () => postMessage({ type: "copy.value", payload: { path } }), children: "Copy" }) })
    ] });
  }
  function NullRenderer({ path }) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s5.nullVal, children: "null" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s5.actions, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { className: "secondary", onClick: () => postMessage({ type: "copy.value", payload: { path } }), children: "Copy" }) })
    ] });
  }
  var s5 = {
